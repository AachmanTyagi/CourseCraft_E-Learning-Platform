...
import "./App.css";
// Replaced image logo with gradient text for loading screen
...
const LoadingScreen = () => (
  <div className="loading-container">
    <div className="text-4xl md:text-6xl font-extrabold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 bg-clip-text text-transparent animate-pulse">
      CourseCraft
    </div>
  </div>
);
