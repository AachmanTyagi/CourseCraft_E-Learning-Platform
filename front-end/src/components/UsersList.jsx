...
const AdminDashboard = () => {
    ...
    const { users, loading, error, fetchAllUsers, deleteUser } = useUser();
                            ...
                            <div key={user._id} className="bg-gray-100 p-4 rounded-lg shadow-md flex flex-col items-center">
                                ...
                                <div className="flex gap-2 mt-3 w-full">
                                    <button
                                        ...
                                        className="flex-1 px-4 py-2 bg-blue-600 text-white rounded-md shadow hover:bg-blue-700 transition"
                                    >
                                        View Details
                                    </button>
                                    <button
