    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-6 flex justify-center">
        <input
          ...
          className="w-full sm:w-2/3 lg:w-1/2 px-4 py-3 bg-white border-2 border-gray-400 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
        />
      </div>
