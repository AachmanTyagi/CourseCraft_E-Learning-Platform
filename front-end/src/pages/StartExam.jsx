...
const StartExam = () => {
  ...
  const { exams, certificateUrl, status, fetchExamQuestions, submitResult, generateCertificate } = useExam();
  ...
  }, [examId, exam, fetchExamQuestions]);
  ...
  const handleGenerateCertificate = () => generateCertificate(examId);
